# 国内如何使用 ChatGPT？最容易懂的 ChatGPT 介绍与教学指南【2025年7月】
---
> 更新时间: 2025-07-26
...
| 网站名称               | 支持功能                                 | 类型      | 访问方式                                                                                                      |
|------------------------|------------------------------------------|----------|----------------------------------------------------------------------------------------------------------------|
| Xsimple                 | GPT-4.0、GPT 4.5、GPT o1、GPT o3、GPT image画图、DeepSeek R1满血版、Claude 4 Sonnet、Grok-3、Gemini 2.5 Pro、AI绘画、AI PPT、AI知识库                  | 网站      | [xsimplechat.com](https://chat.xsimplechat.com)                                                                     |
...
1. **选择镜像站点**：访问推荐的镜像站点，如 chat.xsimplechat.com。
